package Java_GiuaKy2.Giua_Ky_2_Java;
...
public class Main {
    public static void main(String[] args) {
        ...
        executor.execute(new Reader("src/Java_Gk/student.xml", studentQueue));
        executor.execute(new AgeCalculator(studentQueue, resultQueue));

        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter("src/Java_Gk/kq.xml"));
